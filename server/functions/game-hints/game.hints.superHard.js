...
async function returnSuperHardHints (theCurrentGamesRandomNumber) {
    let 
    hintEvaluation = "testing"
    // theCurrentGamesRandomNumberStringValue = theCurrentGamesRandomNumber.toString(),
    // randomlyGeneratedNumber = returnRandomNumberToHideCurrentGamesRandomNumber(999999999).toString(),
    // randomPositionToPlaceRandomlyGeneratedNumbers = Math.floor(Math.random() * (randomlyGeneratedNumber.length + 1));
