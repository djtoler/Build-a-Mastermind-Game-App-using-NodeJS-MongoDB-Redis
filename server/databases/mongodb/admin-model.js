...
const AdminSchema = mongoose.Schema(
  {
    id: string_required,
    points_se_mode: number_default,
    points_e_mode: number_default,
    points_h_mode: number_default,
    points_sh_mode: number_default,
    points_df_mode: number_default,
    count_se_mode: number_default,
    count_e_mode: number_default,
    count_sh_mode: number_default,
    count_h_mode: number_default,
    count_df_mode: number_default,
